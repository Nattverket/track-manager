...
class TestCLIIntegration:
    ...
    def test_check_duplicates_command(self, test_config, temp_output_dir, 
                                     create_test_audio_file):
        """Test check-duplicates command."""
        runner = CliRunner()
        
        # Create test files
        create_test_audio_file(temp_output_dir / "test.mp3",
                              artist="Artist", title="Song", format='mp3')
    ...
    def test_check_duplicates_with_file(self, test_config, temp_output_dir,
                                       create_test_audio_file):
