...
class TestDownloadWorkflow:
    ...
    def test_spotify_download_workflow(self, test_config, temp_output_dir, 
                                       mock_spotify_download, create_test_audio_file):
    ...
    def test_youtube_download_workflow(self, test_config, temp_output_dir,
                                       mock_ytdlp_download, create_test_audio_file):
        ...
        def mock_download(url, output_dir):
            ...
            create_test_audio_file(test_file, artist="Artist", title="Video Title", format='m4a')
            return str(test_file)
    ...
    def test_soundcloud_download_workflow(self, test_config, temp_output_dir,
                                          mock_ytdlp_download, create_test_audio_file):
        """Test complete SoundCloud download workflow."""
        downloader = Downloader(test_config, temp_output_dir)
        
        with patch('track_manager.sources.soundcloud.SoundCloudDownloader.download') as mock_dl:
            # Execute download
    ...
    def test_direct_url_download_workflow(self, test_config, temp_output_dir,
                                          mock_requests_download, create_test_audio_file):
    ...
    def test_format_selection(self, test_config, temp_output_dir, create_test_audio_file):
        ...
        with patch('track_manager.sources.spotify.SpotifyDownloader.download') as mock_dl:
            ...
            mock_dl.assert_called_with("https://open.spotify.com/track/123", "mp3")
            
            # Test auto format
            downloader.download("https://open.spotify.com/track/456", "auto")
            mock_dl.assert_called_with("https://open.spotify.com/track/456", "auto")
