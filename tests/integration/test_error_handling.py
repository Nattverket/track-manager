...
class TestErrorHandling:
    ...
    def test_failed_download_logged(self, test_config, temp_output_dir, mock_spotify_download):
        """Test that failed downloads are logged to file."""
        downloader = Downloader(test_config, temp_output_dir)

        # Configure the mock to raise an exception
        mock_spotify_download.return_value.download.side_effect = Exception("Network error")
