...
class TestDuplicateDetection:
    ...
    def test_normalized_metadata_matching(self, temp_output_dir, create_test_audio_file):
        ...
        new_file = temp_output_dir / "new_file.mp3"
        create_test_audio_file(new_file, artist="Artist", 
    ...
    def test_feat_variations_matching(self, temp_output_dir, create_test_audio_file):
        ...
        # Create existing file
        existing = temp_output_dir / "Artist - Song.mp3"
        create_test_audio_file(existing, artist="Artist", 
                              title="Song (feat. Other)", format='mp3')
        
        # Create new file with different feat. format
        new_file = temp_output_dir / "new_file.mp3"
        create_test_audio_file(new_file, artist="Artist",
                              title="Song ft. Other", format='mp3')
    ...
    def test_not_duplicate_different_title(self, temp_output_dir, create_test_audio_file):
    ...
    def test_scan_library(self, temp_output_dir, create_test_audio_file):
        ...
        create_test_audio_file(temp_output_dir / "file1.mp3", 
                              artist="Artist1", title="Song1", format='mp3')
        create_test_audio_file(temp_output_dir / "file2.mp3",
                              artist="Artist1", title="Song1", format='mp3')  # Duplicate
        create_test_audio_file(temp_output_dir / "file3.m4a",
                              artist="Artist2", title="Song2", format='m4a')
        create_test_audio_file(temp_output_dir / "file4.mp3",
                              artist="Artist2", title="Song2", format='mp3')  # Cross-format duplicate
    ...
    def test_missing_metadata_no_duplicate(self, temp_output_dir, create_test_audio_file):
