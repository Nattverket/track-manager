...
class BaseDownloader(ABC):
    ...
    def create_filename(self, artist: Optional[str], title: Optional[str], 
                       extension: str, fallback: str = "unknown") -> str:
    ...
    def check_duplicate(self, file_path: Path) -> bool:
        ...
        return check_file_duplicate(file_path, self.output_dir, 
